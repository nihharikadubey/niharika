      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="inline-flex items-center gap-2 px-6 py-3 bg-slate-800/50 backdrop-blur-sm border border-slate-600/50 rounded-lg text-slate-300 font-medium hover:bg-slate-700/50 hover:border-slate-500/50 hover:text-white transition-all"
          >
